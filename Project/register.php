    ...
    <body>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
            ...
            <div class="inputbox">
                ...
                <input type="text" placeholder="Smith" name="surname" id="surname" />
            </div><!-- End of surname -->
            <div class="inputbox">
                <label for="email">E-mail:</label>
                <input type="email" id="email" placeholder="someone@somewhere.ie" name="email" />
            </div> <!-- End of Email -->
            <div class="inputbox">
                <label for="passwordOne">Enter Password:</label>
                <input onkeyup = "checkPasswordComplexity(this.value)" type="password" placeholder="*********" name="passwordOne" id="passwordOne">
            </div><!-- End of passwordOne -->
            <!-- onblur="checkPasswordComplexity()" -->
            <div class="inputbox">
                <label for="passwordTwo">Re-Enter Password:</label>
                <input onkeyup = "checkPasswordsMatch(this.value)" type="password" placeholder="*********" name="passwordTwo" id="passwordTwo">
